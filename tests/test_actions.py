...
# -- Fichier app/utils/pokeapi.py :
    # get_pokemon_name
    

# -- Fichier app/routers/trainers.py :

    # create_trainer
    # get_trainers
    # get_trainer
    # create_item_for_trainer
    # create_pokemon_for_trainer
    # D'autres fonctions de gestion des entraîneurs et de leurs objets associés.
    # Fichier app/routers/items.py :
    # get_items

# Fichier app/routers/pokemons.py :
    # get_pokemons
